...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:var(--space-4)">
    <div>
        <div style="font-weight:var(--weight-semibold);font-size:var(--text-lg)">Absent Students</div>
        <div style="font-size:var(--text-sm);color:var(--text-tertiary)">
            Applicants marked absent at their interview. Select one or more to reschedule.
        </div>
    </div>
</div>
